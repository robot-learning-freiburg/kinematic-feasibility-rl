...
const RoboConf tiago_config{
    ...
    .tip_to_gripper_offset = tf::Vector3(0.205, 0.0, 0.0),
    .gripper_to_base_rot_offset = tf::Quaternion(-0.706825, 0, 0, 0.707388),  // offset_q.setRPY(-1.570, 0.0, 0.0)
    // from src/tiago_robot/tiago_bringup/config/motions/tiago_motions.yaml.em
    .neutral_pos_joint_names = {"torso_lift_joint", "arm_1_joint", "arm_2_joint", "arm_3_joint", "arm_4_joint", "arm_5_joint", "arm_6_joint", "arm_7_joint"},

...
namespace modulation_ellipses {
    bool Modulation::exists_test(const std::string& name) {
  ...
  std::vector<ellipse::Ellipse>& Modulation::getEllipses() {
    return ellipses_;
  }
 ...
 void Modulation::setEllipses() {
    ...
    std::string fpath;
    if (exists_test("Ellipse_modulation_models/knnDataAngle.csv")){
        fpath = "Ellipse_modulation_models/";
    } else if (exists_test("../Ellipse_modulation_models/")){
        fpath = "../Ellipse_modulation_models/";
    } else {

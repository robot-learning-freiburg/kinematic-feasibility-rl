...
) : _max_speed_gripper { max_speed_gripper },
    _max_speed_base { max_speed_base },
...
void GaussianMixtureModel::adaptModel(tf::Transform newGoal, tf::Vector3 gmm_base_offset)
{
	...
	for(int i=0;i<_nr_modes;i++)
	{
        ...
        tf_Mu_base_i.setRotation(tf::Quaternion(0.0,0.0,
        ...
        tf_Mu_base_i = utils::tip_to_gripper_goal(tf_Mu_base_i, -gmm_base_offset, tf::Quaternion(0, 0, 0, 1));
...
void GaussianMixtureModel::integrateModel(double current_time, double dt_real, Eigen::VectorXf* current_pose, Eigen::VectorXf* current_speed, bool do_update)
{
	...
	if (current_time_gmm > _MuEigen[_nr_modes-1](0)){ current_time_gmm = _MuEigen[_nr_modes-1](0); }
	...
	tf::Quaternion current_desired_gripper_q = tf::Quaternion(_MuEigen[highest_i](4),_MuEigen[highest_i](5),_MuEigen[highest_i](6),_MuEigen[highest_i](7)).slerp(tf::Quaternion(_MuEigen[secHighest_i](4),_MuEigen[secHighest_i](5),_MuEigen[secHighest_i](6),_MuEigen[secHighest_i](7)), h_ratio);
	...
	tf::Quaternion current_desired_base_q = tf::Quaternion(0.0, 0.0, _MuEigen[highest_i](13), _MuEigen[highest_i](14)).slerp(tf::Quaternion(0.0, 0.0, _MuEigen[secHighest_i](13), _MuEigen[secHighest_i](14)), h_ratio);
	...
	*current_speed = *current_speed + 1 * currAcc;
    ...
    gripper_vel = utils::norm_scale_vel(gripper_vel, 0.0, _max_speed_gripper * dt_real);
    ...
    gripper_rot_vel = utils::norm_scale_vel(gripper_rot_vel, 0.0, _max_speed_gripper_rot * dt_real);
    ...
    base_vel = utils::norm_scale_vel(base_vel, 0.0, _max_speed_base * dt_real);
    base_vel.setZ(0.0);
    ...
    current_speed->coeffRef(12) = utils::clamp_double(current_speed->coeffRef(12), -lim, lim);
